...
In NLP tasks such as Word Sense Disambiguation it is necessary to identify the meaning of a word. As in English language words can have multiple meanings (Polysemy), this is a difficult task in absence of word context. For example take the word 'have' can mean:
* possess, own, or hold.
* experience; undergo.
