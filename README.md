...
In this example (Figure-3), it is shown how each word (here: 'her' and 'have') is represented by a feature vector generated by the network. By reading the sentence, 
        
        "Over the last 8 months, Hillary and those working with her have talked to literally thousands of Americans to understand the strengths and the frailties of this system of ours. They met with over 1,100 health care organizations." 

we can infer that word 'her' correponds to 'Hillary' (to the left of the word), while word 'those' corresponds to 'working with her' (to the right of the word). Based of these references, we are able to answer who these 'her' and 'those' are depending on where in the sequence it occured. Thus it is beneficial to have word representations that are defined based on it's context.
